...
def get_random_rsp():
    ...
    return random.choices(
        [
            ...
            "GN, fucker",
            "ido",
            f"give u {random.randint(1, 1000)} $BTC",
            f"give u {random.randint(1, 1000)} $BTC",
            f"give u {random.randint(1, 1000)} $BTC",
            f"give me your BTC address",
            f"give me your TON address",
            f"give me you ETH address",
            f"give me your wallet address",
            f"give me your wallet address",
            f"give me your wallet address",
            "what's fuck time now?",
            "why are you fuck here?",
            "why are you here?",
            "老司机带带我",
            "老板,你好",
            "老板,发财🤑",
